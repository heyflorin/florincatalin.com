...
components:
  component:
    - description: >-
      ...
      name: Understand
    - description: >-
        Explore design options early enough to minimize the cost of change and reduce the risk of rework. Prototype, validate, and iterate, staying close to the user. Leverage patterns and design systems to establish a consistent design language.
      name: Explore
    - description: >-
