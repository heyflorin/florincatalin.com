...
section:
  - title: Assessing The Current State
    description: The existing Visit Kent website had an...
    sectionimage:
      ...
      shadow: true
  - title: Goals & Metrics
    description: The economic development team sought a fresh and responsive site showcasing the undiscovered and unexpected while also putting visitors first. Hoteliers wanted an easy way for visitors to book their stay. Specifically, staffer's on the Visit Kent team relied on support
    sectionimage:
