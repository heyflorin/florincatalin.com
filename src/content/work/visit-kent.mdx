...
section:
  ...
  - title: Design Iterations
    component: Explore
    description: Working with our content team, I crafted a topline navigation that inspired action and an three-columned layout for aspirational evergreen content. I orchestrated several feedback sessions using InVision and subsequent design iterations, starting with a newly proposed site map, information architecture, and working all the way through wireframes of each section. Between the advisory committe and agency staff, over 300 comments were received and considered accross 3 rounds of design revisions.
    sectionimage:
      alt: A computer screen showing UI design for the Visit Kent website
  ...
  - title: Simplified Navigation
    component: Materialize
    description: In user testing, we found that both users and content owners desired a simplified menu structure. When asked to navigate a complete page and then move to another, most utilized the footer navigation. The design is aimed at maintaining visual heirarchy while simplifying with subtle interaction and animation.
    sectionimage:
  ...
  - title: Story Templates
    component: Materialize
    description: Talk about story template design and development here, show a photo
    sectionimage:
      alt: Animation of Visit Kent's footer menu
      dark: /img/vk-interactions-footer.jpg
      light: /img/vk-interactions-footer.jpg
  ...
  - title: Hotel listings
    description: Talk about hotel listings design and development here, show a photo
    sectionimage:
      alt: Animation of Visit Kent's footer menu
      dark: /img/vk-interactions-footer.jpg
      light: /img/vk-interactions-footer.jpg
  ...
  - title: Results & Impact
    description: Talk about the results of this project
---
