---
templateKey: project
title: Refreshed a Travel Basecamp
...
section:
  - title: Assessing The Current State
    ...
    description: To better understand the complexity of the website, We crawled the existing site for a full picture of the information and interaction heirarchy. Roughly 15% of page links were broken and there was a deeply nested information architecture. These findings formed the base of the new IA that we delivered to stakeholders.
    sectionimage:
  ...
  - title: Traveling Personas
    component: Understand
    description: Conducted research on Kent as a destination and on the user's motivations for visiting the website. Our goal was to understand user behavior and planning strategy employed prior to making hotel reservations for various destinations. Parents were of particular interest, as were people in the 30-50 age range who were more likely to plan ahead prior to traveling.
    sectionimage:
  ...
  - title: Design Iterations
    component: Explore
    description: Working with our content team, I designed a simplified action-inspiring topline navigation and a three-columned layout for evergreen content. I orchestrated several feedback sessions using InVision and subsequent design iterations, starting with a newly proposed site map, information architecture, and working all the way through wireframes of each section. Between the advisory committe and agency staff, over 300 comments were received and considered accross 3 rounds of design revisions.
    sectionimage:
  ...
  - title: Simplified Navigation
    component: Materialize
    description: In user testing, we found that both users and content owners desired a simplified menu structure. When asked to navigate a complete page and then move to another, most utilized the footer navigation. The design is aimed at maintaining visual heirarchy while simplifying with subtle interactions and animations.
    sectionimage:
  ...
  - title: Hotel listings
    component: Materialize
    description: I worked with the lodging committe to gather requirements for a custom API implmentation for the lodging directory. I designed and implmeneted a masonry layout with each card component pulling information from the TripAdvisor API. The primary call to action was to redirect users to the hotel's website using a new tab.
    sectionimage:
